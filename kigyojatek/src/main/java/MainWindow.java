...
public class MainWindow extends JFrame
{
	...
	public void reinit(){
		...
		table.getSnakegame().getSnake().get(0).setState((byte) 4,
				(byte) 2,SnakeBodyPart. Direction.RIGHT);
		table.getSnakegame().getSnake().get(1).setState((byte) 3,
				(byte) 2, SnakeBodyPart.Direction.RIGHT);
		table.getSnakegame().getSnake().get(2).setState((byte) 2,
				(byte) 2, SnakeBodyPart.Direction.RIGHT);
	...
	public MainWindow()
	{
		...
		init ();
		bg = new JLabel();
		bg.setIcon(new ImageIcon(getClass().getResource(
				SnakePic.getDesignPrefix() + SnakePic.PicFile.OPENBG)));
		// bg.setSize(200, 200);
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			if (opts != null)
			{
				if (e.getSource() == opts.close)
				{
					...
					bg.setIcon(new ImageIcon(getClass().getResource(
							SnakePic.getDesignPrefix()
									+ SnakePic.PicFile.OPENBG)));
					// bg.setSize(200, 200);
					return;
				}
	...
	{
		bg.setIcon(new ImageIcon(getClass().getResource(
				SnakePic.getDesignPrefix() + SnakePic.PicFile.GAMEOVERBITE)));
	...
	{
		bg.setIcon(new ImageIcon(getClass().getResource(
				SnakePic.getDesignPrefix() + SnakePic.PicFile.GAMEOVERSTUN)));
		panel.remove(getTable());
		panel.add(bg);
		repaint();
